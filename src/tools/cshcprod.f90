...
!   fortran 2003 version released in CUTEst, 3rd September 2014
      ...
      SUBROUTINE CUTEST_Cint_cshcprod( status, n, m, goth, X, Y,               &
...
!  --------------------------------------------------------------------------
      ...
      goth_fortran = goth
      CALL CUTEST_cshcprod( status, n, m, goth_fortran, X, Y,                  &
                            nnz_vector, INDEX_nz_vector, VECTOR,               &
                            nnz_result, INDEX_nz_result, RESULT )

      RETURN

!  end of subroutine CUTEST_Cint_cshcprod

      END SUBROUTINE CUTEST_Cint_cshcprod
...
!  --------------------------------------------------------------------------
      ...
      CALL CUTEST_cshcprod_threadsafe( CUTEST_data_global,                     &
...
!  end of subroutine CUTEST_cshcprod
...
!  end of subroutine CUTEST_cshcprod_threaded
...
!   fortran 2003 version released in CUTEst, 3rd September 2014
      ...
      SUBROUTINE CUTEST_cshcprod_threadsafe( data, work, status, n, m, goth,   &
...
!  end of subroutine CUTEST_cshcprod_threadsafe
      ...
      END SUBROUTINE CUTEST_cshcprod_threadsafe
