...
Module CUTEst_Data
  ...
  Private
  Public :: CUTEst_Data_Initialize, CUTEst_Data_Free
...
Contains
  ...
  Subroutine CUTEst_Data_Initialize( problem, input )
    !
    ! Allocate main problem data structure
    !
    Implicit None
    !
    Type( CUTEst_Data_type ), Intent( Inout ) :: problem
    ...
    !
10  Format( 'CUTEst_Data_Initialize:: invalid problem dimensions:', &
         'n = ', I6, ', m = ', I6 )
20  Format( 'CUTEst_Data_Initialize:: ', I2, ' errors in memory allocation' )

  End Subroutine CUTEst_Data_Initialize

  !============================================================================

  Subroutine CUTEst_Data_Free( problem )
...
100 Format( I9, ' errors encountered in freeing memory' )
  ...
  End Subroutine CUTEst_Data_Free

  !============================================================================

End Module CUTEst_Data
