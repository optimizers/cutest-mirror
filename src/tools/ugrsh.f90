! THIS VERSION: CUTEST 1.0 - 28/12/2012 AT 13:55 GMT.
...
!   fortran 2003 version released in CUTEst, 23rd November 2012
      ...
      SUBROUTINE CUTEST_ugrsh( status, n, X, G,                                &
...
!  -------------------------------------------------------------------
      ...
      CALL CUTEST_ugrsh_threadsafe( CUTEST_data_global,                        &
                                    CUTEST_work_global( 1 ), status, n,        &
                                    X, G, nnzh, lh, H_val, H_row, H_col )
      RETURN

!  end of subroutine CUTEST_ugrsh

      END SUBROUTINE CUTEST_ugrsh

!-*-*-  C U T E S T    U G R S H _ t h r e a d e d   S U B R O U T I N E  -*-*-
...
!   fortran 2003 version released in CUTEst, 23rd November 2012
      ...
      SUBROUTINE CUTEST_ugrsh_threaded( status, n, X, G,                       &
...
!  end of subroutine CUTEST_ugrsh_threaded

      END SUBROUTINE CUTEST_ugrsh_threaded

!-*-  C U T E S T    U G R S H _ t h r e a d s a f e    S U B R O U T I N E  -*-
...
!   fortran 2003 version released in CUTEst, 23rd November 2012
      ...
      SUBROUTINE CUTEST_ugrsh_threadsafe( data, work, status, n, X, G,         &
                                          nnzh, lh, H_val, H_row, H_col )
      USE CUTEST
      INTEGER, PARAMETER :: wp = KIND( 1.0D+0 )
...
!  end of subroutine CUTEST_ugrsh_threadsafe
      ...
      END SUBROUTINE CUTEST_ugrsh_threadsafe
